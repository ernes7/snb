...
from .services import (get_bat_avg_leaders, get_bat_ops_leaders,
                       get_bat_hr_leaders, get_bat_hits_leaders,
                       get_bat_rbi_leaders, get_pitch_wins_leaders,
                       get_pitch_era_leaders, get_pitch_whip_leaders,
...
def leaders() -> str:
    return render_template('leaders.html',
                           ...
                           pitch_whip=get_pitch_whip_leaders(),
